...
// ---------- Conversion functions for numbers (same as before) ----------
...
// ---------- Main function that splits the input string ----------
int main() {
	string input;
	...
	while (true) {
		...
		if (dotPos == string::npos) {
			...
			paiseStr = input.substr(dotPos + 1);
		...
		cout <<"\n rupeesStr  -> "<<rupeesStr<<endl;
		cout <<"\n paiseStr  -> "<<paiseStr<<endl;
		// ---------- Convert to words ----------
		string result;
